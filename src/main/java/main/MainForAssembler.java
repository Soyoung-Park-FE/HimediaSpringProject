...
public class MainForAssembler {
	...
	{
		System.out.println("이메일 주소와 패스워드가 일치하지않습니다.");

	}

	MemberRegisterService regSvc = assembler.getMemberRegisterService();
	RegisterRequest req = new RegisterRequest();req.setEmail(args[1]);req.setName args[2];req.setPassword(args[3]);req.setConfirmPassword(args[4]);
	...
	// 계획되지 않은 명령어 또는 형식에 맞지 않은 명령어가 입력되었을 때, 사용법을 안내하는 메서드
	// 사용법을 안내하는 메서드
